...
{\bf \huge \fbox{\textsc{\problemlabel}} \problemtitle}
\begin{flushright}
    \begin{minipage}[t]{\maxof
        {\widthof{XXXXXAuthor: \hspace{2.1em}\problemauthor{}}}
        {\widthof{XXXXXPreparation: \problempreparation{}}}
    }
        \textsc{Author: \hspace{2.1em}\problemauthor{}} \\
        \textsc{Preparation: \problempreparation{}}
    \end{minipage}
\end{flushright}
\vspace{2em}%
}
